module.exports = function(mongoose, db, defaultActorImage, modelNames, defaultBaseUrls) {
    ...
    var activitySchema = new Schema(ActivityHash);
    activitySchema.pre('save', function(next){
        if(!this.url && defaultBaseUrls)
            this.url = defaultBaseUrls.Activity + "/" + this._id;
        next();
    });
    var types = {
